...
export const metadata: Metadata = {
  title: "Manglara | Terms and Conditions",
  description: "Manglara Terms and Conditions",
};
  ...
  return (
    <main className="p-10">
      ...
      <TypographyP className="mb-6">
        Welcome to Manglara, an open-source social media platform designed for
      ...
      <TypographyP className="mb-6">
        By creating an account or using Manglara, you agree to these Terms and
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          post. By posting, you grant Manglara a worldwide, royalty-free license
        ...
        <li>
          ...
          Manglara reserves the right to remove content that violates these
          guidelines.
        </li>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          Interfere with the operation of Manglara or disrupt other users&apos;
          experience.
        </li>
      </ul>
      ...
      <TypographyP className="mb-6">
        Manglara reserves the right to suspend or terminate your account if you
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          service, Manglara does not guarantee continuous availability and may
          experience downtime.
        </li>
        ...
        <li>
          ...
          law, Manglara disclaims liability for any indirect, incidental, or
      ...
      <TypographyP className="mb-6">
        Manglara may update these Terms and Conditions periodically. Users will
      ...
      <TypographyP className="mb-6">
        Thank you for being part of the Manglara community. We aim to provide a
