...
export const metadata: Metadata = {
  title: "Manglara | Privacy Policy",
  description: "Manglara Privacy Policy",
};
  ...
  return (
    <main className="p-10">
      ...
      <TypographyP className="mb-6">
        At Manglara, we value your privacy and are committed to protecting your
      ...
      <TypographyP className="mb-6">
        When you use Manglara, we may collect the following types of
        information:
      </TypographyP>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          ...
          Manglara, such as IP address, browser type, and operating system.
        </li>
      </ul>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          Service Provision: To operate and maintain the Manglara app, including
      ...
      <TypographyP className="mb-6">
        Manglara may contain links to external websites or services not operated
      ...
      <TypographyP className="mb-6">
        Thank you for trusting Manglara with your personal information. We are
